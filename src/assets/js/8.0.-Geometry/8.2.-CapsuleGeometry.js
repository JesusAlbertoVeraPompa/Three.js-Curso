//==============================================================================
// assets/js/8.0.-Geometry/8.2.-CapsuleGeometry.js
//==============================================================================
...
const geometry = new THREE.CapsuleGeometry( 5, 5, 10, 20, 1 );
...
function animate() {
    ...
    // Hacemos girar el cubo (y el wireframe girará con él porque es su hijo)
